...
export const QuestionColored: React.FunctionComponent<IconBaseProps> = (
  props: IconBaseProps,
) => {
  return GenIcon({
    tag: 'svg',
    ...
    child: [
      {
        tag: 'g',
        attr: { clipPath: 'url(#clip0_98_6524)' },
        child: [
          {
            tag: 'path',
            attr: {
              fillRule: 'evenodd',
              clipRule: 'evenodd',
              d: 'M29.9404 67.7394C30.5225 67.6648 31.1138 67.7231 31.6771 67.8879C46.5142 72.2303 62.9417 66.0775 71.0149 52.0942C80.4921 35.6792 74.8679 14.6895 58.4529 5.21225C42.0379 -4.26496 21.0482 1.35923 11.571 17.7742C5.22197 28.771 5.65042 41.8209 11.5603 52.0872C11.983 52.8214 12.2003 53.66 12.1413 54.5051L11.3875 65.2944C11.2116 67.8122 13.3828 69.8616 15.8863 69.5408L29.9404 67.7394Z',
              fill: '#6155A6',
            },
          },
          {
