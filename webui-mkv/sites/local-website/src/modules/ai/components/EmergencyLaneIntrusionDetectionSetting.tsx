...
export interface EmergencyLaneIntrusionDetectionSettingProps {
  className?: string;
...
export const EmergencyLaneIntrusionDetectionSetting: React.FC<EmergencyLaneIntrusionDetectionSettingProps> = ({
  leftContent,
  osdConfig,
  zones = [],
  onZonesChange,
