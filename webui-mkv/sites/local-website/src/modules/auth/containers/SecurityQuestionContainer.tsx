...
export const SecurityQuestionContainer: React.FC = () => {
  const {loading, questionsList, setSecurityQuestion } = useSecurityQuestion();
  const [form] = useForm();
    ...
    <Wrapper>
      <Form layout="horizontal" form={form} onFinish={onFinish}>
        <Flex justify="center" direction="column" align="center">
          <Box padding={['s16', 's8']}>
            <Text fontSize="l">{t('HeadSecurityQuestion')}</Text>
          </Box>
          <Box marginTop="s24">
            <FormBuilder<ISecurityQuestionPayload>
              ...
              configs={{
                ID1: {
                  ...
                  // options = array of option_list_question_1
