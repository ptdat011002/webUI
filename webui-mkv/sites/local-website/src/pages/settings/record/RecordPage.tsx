...
const RecordSettingContainer = React.lazy(
  () => import('modules/record/containers/RecordSettingContainer'),
);
        ...
        items={[
          {
            key: 'setting',
            label: t('record'),
            screen: <RecordSettingContainer />,
            onCLick: () => setActiveTab('setting'),
          },
          {
            key: 'schedule',
            label: t('schedule'),
            screen: <RecordScheduleContainer type="Record" />,
